...
export const SocialLogin = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <Button
        type="button"
        className="w-full h-14 border-2 border-slate-300 bg-white hover:bg-slate-50 hover:border-emerald-400 text-slate-700 font-semibold transition-all flex items-center justify-center gap-3 rounded-2xl"
      ...
      <div className="relative">
        ...
        <div className="relative flex justify-center text-xs uppercase">
          <span className="bg-white px-4 text-slate-400">Coming Soon</span>
        </div>
      </div>
