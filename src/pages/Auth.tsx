...
const Auth = () => {
  ...
  return <div className="min-h-screen bg-gradient-to-br from-slate-50 via-emerald-50/30 to-amber-50/20 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute top-4 left-4 z-50">
        <Button variant="outline" size="sm" onClick={() => setAuthMode(authMode === 'unified' ? 'classic' : 'unified')} className="bg-white border-emerald-500 text-emerald-600 hover:bg-emerald-50 hover:border-emerald-600 transition-all">
          {authMode === 'unified' ? <>
      ...
      <div className="w-full max-w-5xl grid md:grid-cols-2 gap-8 items-center relative z-10">
        ...
        <div className="text-center md:text-left">
          ...
          {authMode === 'unified' && <div className="mt-8 space-y-3 hidden md:block">
