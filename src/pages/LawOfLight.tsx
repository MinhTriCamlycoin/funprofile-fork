...
const LawOfLight = () => {
  ...
  const checklistItems = ['Con sống chân thật với chính mình', 'Con chịu trách nhiệm với năng lượng con phát ra', 'Con sẵn sàng học – sửa – nâng cấp', 'Con chọn yêu thương thay vì phán xét', 'Con chọn ánh sáng thay vì cái tôi'];
  const divineMantras = ['I am the Pure Loving Light of Father Universe.', 'I am the Will of Father Universe.', 'I am the Wisdom of Father Universe.', 'I am Happiness.', 'I am Love.', 'I am the Money of the Father.', 'I sincerely repent, repent, repent.', 'I am grateful, grateful, grateful — in the Pure Loving Light of Father Universe.'];
  return <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden hidden md:block">
        ...
        background: i % 3 === 0 ? 'radial-gradient(circle, rgba(212,175,55,0.9), rgba(212,175,55,0.3))' : i % 3 === 1 ? 'radial-gradient(circle, rgba(255,255,255,0.95), rgba(255,255,255,0.4))' : 'radial-gradient(circle, rgba(255,215,0,0.8), rgba(255,215,0,0.2))',
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-8 md:mb-12">
            ...
            border: '3px solid rgba(212,175,55,0.5)'
              ...
              <img src={angelAvatar} alt="Angel" className="w-full h-full object-cover object-[center_25%]" style={{
              filter: 'drop-shadow(0 0 15px rgba(212,175,55,0.8))'
            }} />
            </div>
            
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-3 md:mb-4 law-of-light-title" style={{
            ...
            <p className="text-base md:text-xl font-medium tracking-widest mb-2" style={{
            fontFamily: 'Space Grotesk, Inter, sans-serif',
            color: '#B8860B'
          }}>
              THE LAW OF LIGHT
          ...
          {/* Main Content Card */}
          <div className="relative rounded-2xl md:rounded-3xl p-4 sm:p-6 md:p-8 lg:p-12 mb-6 md:mb-8 law-of-light-card" style={{
          ...
          boxShadow: '0 10px 60px rgba(212,175,55,0.15), 0 0 0 1px rgba(255,255,255,0.8), inset 0 0 60px rgba(255,255,255,0.5)'
            ...
            <div className="mb-8 md:mb-10">
              ...
              <p className="text-center text-sm md:text-lg font-semibold mb-4 md:mb-6" style={{
              color: '#8B7355',
              fontFamily: 'Space Grotesk, Inter, sans-serif'
            }}>
              ...
              lineHeight: '1.9'
                ...
                color: '#8B7355'
              }}>FUN Ecosystem không dành cho tất cả mọi người.</p>
                <p className="font-semibold" style={{
                color: '#8B7355'
              }}>FUN Ecosystem chỉ dành cho những linh hồn có ánh sáng, hoặc đang hướng về ánh sáng.</p>
              </div>
            </div>
            ...
            <div className="mb-10">
              ...
              <ul className="space-y-2 ml-4 text-gray-700" style={{
              fontFamily: 'Space Grotesk, Inter, sans-serif',
              lineHeight: '1.9'
            }}>
              ...
              background: 'rgba(212,175,55,0.08)'
                ...
                <p className="italic text-gray-600" style={{
                fontFamily: 'Space Grotesk, Inter, sans-serif'
              }}>
            ...
            <div className="mb-10">
              ...
              <ul className="space-y-1 ml-4 mt-2 text-gray-700" style={{
              fontFamily: 'Space Grotesk, Inter, sans-serif'
            }}>
            ...
            <div className="mb-10">
              ...
              background: 'rgba(212,175,55,0.08)'
                ...
                <p className="italic text-gray-600 text-center" style={{
                fontFamily: 'Space Grotesk, Inter, sans-serif'
              }}>
                  Không drama.<br />
                  Không thao túng.<br />
                  ...
                  color: '#B8860B'
                }}>Chỉ có Hợp tác trong Yêu Thương Thuần Khiết.</span>
                </p>
              </div>
            </div>
            ...
            background: 'radial-gradient(ellipse at center, rgba(212,175,55,0.12) 0%, rgba(255,255,255,0.5) 70%)'
              ...
              <p className="text-lg italic text-gray-700 mb-4" style={{
              fontFamily: 'Space Grotesk, Inter, sans-serif',
              lineHeight: '1.9'
            }}>
            ...
            {/* 🕊️ Checklist Section */}
            <div className="mb-10">
              <h3 className="text-xl font-bold text-center mb-6" style={{
              color: '#D4AF37'
            }}>
                🕊️ Checklist cho Users FUN Ecosystem
              </h3>
              
              {!isReadOnly ? <div className="space-y-4 max-w-xl mx-auto">
                  {checklistItems.map((item, index) => <label key={index} className="flex items-center gap-4 p-4 rounded-xl cursor-pointer transition-all duration-300" style={{
                ...
                boxShadow: checklist[index] ? '0 4px 20px rgba(212,175,55,0.2)' : 'none'
                      ...
                      <Checkbox checked={checklist[index]} onCheckedChange={() => handleCheckboxChange(index)} className="w-6 h-6 border-2 data-[state=checked]:bg-yellow-500 data-[state=checked]:border-yellow-500" style={{
                  borderColor: '#D4AF37'
                }} />
                ...
                </div> : <ul className="space-y-3 max-w-xl mx-auto text-gray-700" style={{
              fontFamily: 'Space Grotesk, Inter, sans-serif'
            }}>
                  {checklistItems.map((item, index) => <li key={index} className="flex gap-2">
            ...
            <div className="mb-10">
              ...
              transform: 'perspective(1000px) rotateX(2deg)'
                ...
                <ol className="space-y-4">
                  {divineMantras.map((mantra, index) => <li key={index} className="flex gap-3 items-start">
                    ...
                    boxShadow: '0 2px 8px rgba(212,175,55,0.4)'
                      ...
                      <p className="text-gray-700 font-medium pt-1" style={{
                    fontFamily: 'Space Grotesk, Inter, sans-serif'
                  }}>
                        {mantra}
                      </p>
            ...
            {!isReadOnly && <div className="mt-10 text-center">
                <Button onClick={handleAccept} disabled={!allChecked || loading} className="relative px-12 py-6 text-lg font-bold rounded-2xl transition-all duration-500 disabled:opacity-50 disabled:cursor-not-allowed border-0" style={{
              background: allChecked ? 'linear-gradient(135deg, #D4AF37 0%, #FFD700 40%, #F0C000 60%, #D4AF37 100%)' : 'linear-gradient(135deg, #9CA3AF 0%, #6B7280 100%)',
              boxShadow: allChecked ? '0 0 30px rgba(212,175,55,0.5), 0 0 60px rgba(255,215,0,0.3), 0 0 90px rgba(212,175,55,0.2)' : 'none',
            ...
            {isReadOnly && <div className="text-center pt-8">
                <Button onClick={() => navigate(-1)} variant="outline" className="px-8 py-3 border-2 hover:bg-yellow-50" style={{
              borderColor: '#D4AF37',
              color: '#D4AF37'
            }}>
                  ← Quay lại
